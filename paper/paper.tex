...
\thanks{This work was produced with a total API budget of \$0.08 using four low-cost hosted language models. Code and data: \url{https://github.com/mnekrashevich/synthetic-economy}}}
...
Our results establish that small language models can serve as cheap, zero-shot generators of structurally coherent economic microdata, while precisely identifying the marginals that require post-hoc correction before such data are fit for research use.
\end{abstract}
...
\begin{enumerate}[leftmargin=*, itemsep=1pt]
  ...
  \item \textbf{Calibrate}: reweight records to match known population marginals (employment rate, education distribution) using importance sampling or post-stratification.
...
We recommend that any use of LLM-generated synthetic data for research be accompanied by: (i)~transparent reporting of the generation protocol, (ii)~validation against known aggregates, and (iii)~explicit acknowledgment of the known distortions (marginals, gender gap, unemployment rates).
...
Small LLMs are therefore promising as cheap zero-shot generators of structurally coherent microdata, provided their marginals are corrected---ideally by combining LLM-generated joint structure with marginal calibration.
